<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Club controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(ClubController::class)) {
    throw new \RuntimeException('SportsManagement native Club controller could not be loaded.', 500);
}
