<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Currentseason controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(CurrentseasonController::class)) {
    throw new \RuntimeException('SportsManagement native Currentseason controller could not be loaded.', 500);
}
