...
if (!class_exists(JlextindividualsportController::class)) {
    ...
    require_once JPATH_ADMINISTRATOR . '/components/com_sportsmanagement/src/Controller/JlextindividualsportController.php';
}

if (!class_exists(JlextindividualsportController::class)) {
    throw new \RuntimeException('SportsManagement native Jlextindividualsport controller could not be loaded.', 500);
}
