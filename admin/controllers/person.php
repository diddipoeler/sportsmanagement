...
function save()
  ...
  // Check for request forgeries
    ...
    $post['extended'][$key] = $value;
		...
		if ($model->save($post))
		{
			$msg = JText::_('COM_SPORTSMANAGEMENT_ADMIN_PERSON_CTRL_SAVED');
    }
    else
		{
			$msg = JText::_('COM_SPORTSMANAGEMENT_ADMIN_PERSON_CTRL_ERROR_SAVE').$model->getError();
		}
    ...
    if ($this->getTask() == 'save')
		{
			$link = 'index.php?option=com_sportsmanagement&view=persons';
		}
		else
		{
			$link = 'index.php?option=com_sportsmanagement&view=person&layout=edit&id='.$pid;
		}
		#echo $msg;
