<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Position controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(PositionController::class)) {
    throw new \RuntimeException('SportsManagement native Position controller could not be loaded.', 500);
}
