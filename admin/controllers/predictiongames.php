<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Predictiongames controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(PredictiongamesController::class)) {
    throw new \RuntimeException('SportsManagement native Predictiongames controller could not be loaded.', 500);
}
