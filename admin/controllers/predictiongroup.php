<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Predictiongroup controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(PredictiongroupController::class)) {
    throw new \RuntimeException('SportsManagement native Predictiongroup controller could not be loaded.', 500);
}
