<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Projectteams controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(ProjectteamsController::class)) {
    throw new \RuntimeException('SportsManagement native Projectteams controller could not be loaded.', 500);
}
