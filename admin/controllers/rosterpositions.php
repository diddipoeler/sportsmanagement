<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Rosterpositions controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(RosterpositionsController::class)) {
    throw new \RuntimeException('SportsManagement native Rosterpositions controller could not be loaded.', 500);
}
