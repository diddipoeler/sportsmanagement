<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Round controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(RoundController::class)) {
    throw new \RuntimeException('SportsManagement native Round controller could not be loaded.', 500);
}
