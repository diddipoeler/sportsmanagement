<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Seasons controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(SeasonsController::class)) {
    throw new \RuntimeException('SportsManagement native Seasons controller could not be loaded.', 500);
}
