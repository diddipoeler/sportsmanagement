<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Team controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(TeamController::class)) {
    throw new \RuntimeException('SportsManagement native Team controller could not be loaded.', 500);
}
