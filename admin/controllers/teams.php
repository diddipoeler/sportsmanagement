<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Teams controller.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(TeamsController::class)) {
    throw new \RuntimeException('SportsManagement native Teams controller could not be loaded.', 500);
}
