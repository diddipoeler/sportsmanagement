...
public function makeRoute($uri) {
    ...
    $option = JRequest::getCmd('option');
        ...
        $mainframe->enqueueMessage(JText::_('sportsmanagementModelDatabaseTools result<br><pre>'.print_r($results,true).'</pre>'),'Notice');
		...
		if (!$this->_db->query())
		{
			$mainframe->enqueueMessage(JText::_('sportsmanagementModelDatabaseTools getErrorMsg<br><pre>'.print_r($this->_db->getErrorMsg(),true).'</pre>'),'Error');
			return false;
		}
        }		
