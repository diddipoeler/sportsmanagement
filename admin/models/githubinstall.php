...
$p_dir = JPATH_SITE.DS.'components'.DS.$option.DS.'plugins'.DS.'content'.DS.$gitinstall.DS;
$p_dir = JPath::clean($p_dir);
// Detect the package type
$type = JInstallerHelper::detectType($p_dir); 
$package['packagefile'] = null;
...
$src = JPATH_SITE.DS.'tmp'.DS.'sportsmanagement-master'.DS.'site'.DS.'plugins'.DS.'content';
$ordner = JFolder::folders($src);
