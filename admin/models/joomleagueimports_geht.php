...
INSERT INTO jos_sportsmanagement_match_player (id,match_id,teamplayer_id,came_in,in_for,in_out_time)
select
mp.id,  
mp.match_id, 
stp.id as teamplayer_id,
...
inner join jos_joomleague_project as p on p.id = pt.project_id

left join jos_sportsmanagement_season_team_person_id as stp on 
stp.person_id = tp.person_id
and stp.team_id = pt.team_id
and stp.season_id = p.season_id
...
inner join jos_joomleague_team_player as tp on tp.id = mp.teamplayer_id
inner join jos_joomleague_project_team as pt on pt.id = tp.projectteam_id
inner join jos_joomleague_project as p on p.id = pt.project_id
