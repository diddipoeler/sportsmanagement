 ...
 */
class sportsmanagementModelmatchreferee extends JModelAdmin
{
	/**
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_sportsmanagement.edit.matchreferee.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
