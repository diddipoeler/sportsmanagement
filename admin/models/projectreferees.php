...
/**
	...
	protected function getListQuery()
	{
		...
		{
        $query->where('(LOWER(p.lastname) LIKE ' . Factory::getDbo()->Quote( '%' . $this->getState('filter.search') . '%' ).
...
$query->order(Factory::getDbo()->escape($this->getState('list.ordering', 'p.lastname')).' '.
