<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Seasonteamperson model.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(SeasonteampersonModel::class)) {
    throw new \RuntimeException('SportsManagement native Seasonteamperson model could not be loaded.', 500);
}
