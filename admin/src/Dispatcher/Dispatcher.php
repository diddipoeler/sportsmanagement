...
final class Dispatcher extends ComponentDispatcher
{
    ...
    private const NATIVE_EDIT_VIEWS = ['clubname', 'eventtype', 'extrafield', 'league', 'player', 'project', 'round', 'season', 'sportstype', 'team'];
    private const SAFE_STANDARD_CRUD_CONTROLLERS = ['clubname', 'clubnames', 'league', 'player', 'project', 'round', 'season', 'seasons', 'sportstype', 'sportstypes', 'team'];
