...
{
    private const MODERN_DISPLAY_VIEWS = ['agegroups','close','clubnames','clubs','currentseasons','divisions','eventtypes','extrafields','leagues','playgrounds','positions','rosterpositions','seasons','sportstypes','teams'];
