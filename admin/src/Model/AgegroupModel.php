...
if (!class_exists('sportsmanagementModelagegroup')) {
    \JLoader::import('components.com_sportsmanagement.models.agegroup', JPATH_ADMINISTRATOR);
}

/**
 * Namespaced adapter for the existing Agegroup model.
 */
class AgegroupModel extends \sportsmanagementModelagegroup
{
}
