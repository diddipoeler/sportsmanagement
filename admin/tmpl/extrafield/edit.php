<?php
/**
 * Native Joomla 5/6 administrator SportsManagement Extrafield edit layout.
 *
 * @version    5.6.0
 * @author     diddipoeler
        ...
        <div class="col-12 col-lg-10">
            <?php foreach ($this->form->getFieldsets() as $fieldset) : ?>
                <fieldset class="options-form mb-4">
                    ...
                    <?php if (!empty($fieldset->description)) : ?><div class="alert alert-info"><?php echo Text::_($fieldset->description); ?></div><?php endif; ?>
