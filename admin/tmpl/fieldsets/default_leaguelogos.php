<?php
/**
 * Native Joomla 5/6 administrator league logo history layout.
 *
 * @version    5.6.0
...
$renderLogo = static function (object $item) use ($escape): string {
    ...
    $modalId = 'jsm-league-logo-' . (int) ($item->id ?? 0);
    $title = 'Logo';
...
$form = new Form('leaguelogohistory');
$form->addFormPath(JPATH_COMPONENT . '/models/forms');
$form->loadFile('leaguelogohistory', false);
?>
<p>Hier können Sie die Wappen zu den Ligen hinterlegen.</p>
