<?php
/**
 * Native Joomla 5/6 administrator playground logo history layout.
 *
 * @version    5.6.0
...
$renderLogo = static function (object $item) use ($escape): string {
    ...
    $modalId = 'jsm-playground-logo-' . (int) ($item->id ?? 0);
    $title = 'Logo';
...
$form = new Form('playgroundlogohistory');
$form->addFormPath(JPATH_COMPONENT . '/models/forms');
$form->loadFile('playgroundlogohistory', false);
?>
<p>Hier können Sie die Wappen zu den Stadien hinterlegen.</p>
