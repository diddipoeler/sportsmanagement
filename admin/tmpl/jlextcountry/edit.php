...
?>
<form
    action="<?php echo Route::_('index.php?option=com_sportsmanagement&view=jlextcountry&layout=edit&id=' . $itemId); ?>"
    method="post"
    name="adminForm"
    id="jlextcountry-form"
    class="form-validate"
>
    <?php echo HTMLHelper::_('uitab.startTabSet', 'jlextcountry-tabs', [
        'active' => 'jlextcountry-' . (array_key_first($fieldsets) ?: 'details'),
        'recall' => true,
        'breakpoint' => 768,
    ]); ?>
    ...
    <?php foreach ($fieldsets as $fieldsetName => $fieldset) : ?>
        ...
        ?>
        <?php echo HTMLHelper::_('uitab.addTab', 'jlextcountry-tabs', 'jlextcountry-' . $fieldsetName, Text::_($label !== '' ? $label : $fieldsetName)); ?>
