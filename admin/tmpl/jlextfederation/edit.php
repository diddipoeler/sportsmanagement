...
?>
<form
    action="<?php echo Route::_('index.php?option=com_sportsmanagement&view=jlextfederation&layout=edit&id=' . $itemId); ?>"
    method="post"
    name="adminForm"
    id="jlextfederation-form"
    class="form-validate"
>
    <?php echo HTMLHelper::_('uitab.startTabSet', 'jlextfederation-tabs', [
        'active' => 'jlextfederation-' . (array_key_first($fieldsets) ?: 'details'),
        'recall' => true,
        'breakpoint' => 768,
    ]); ?>
    ...
    <?php foreach ($fieldsets as $fieldsetName => $fieldset) : ?>
        ...
        ?>
        <?php echo HTMLHelper::_('uitab.addTab', 'jlextfederation-tabs', 'jlextfederation-' . $fieldsetName, Text::_($label !== '' ? $label : $fieldsetName)); ?>
