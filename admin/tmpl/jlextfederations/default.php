<?php
/**
 * Native Joomla 5/6 federation administrator list layout.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
?>
<form action="<?php echo Route::_('index.php?option=com_sportsmanagement&view=jlextfederations'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="container-fluid">
        <div class="card mb-3"><div class="card-body"><div class="row g-2 align-items-end">
            ...
            <div class="col-12 col-md-3 d-flex gap-2">
                ...
                <a class="btn btn-secondary" href="<?php echo Route::_('index.php?option=com_sportsmanagement&view=jlextfederations'); ?>"><?php echo Text::_('JSEARCH_FILTER_CLEAR'); ?></a>
            </div>
        </div></div></div>
                ...
                <?php else : ?>
                    <?php foreach ($this->items as $i => $item) : ?>
                        <tr>
                            ...
                            <td><a href="<?php echo Route::_('index.php?option=com_sportsmanagement&task=jlextfederation.edit&id=' . (int) $item->id); ?>"><?php echo htmlspecialchars((string) $item->name, ENT_QUOTES, 'UTF-8'); ?></a></td>
