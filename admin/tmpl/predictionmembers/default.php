<?php
/**
 * Native Joomla 5/6 prediction members administrator list layout.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
?>
<form action="<?php echo Route::_('index.php?option=com_sportsmanagement&view=predictionmembers'); ?>"
      method="post"
      id="adminForm"
      name="adminForm">
