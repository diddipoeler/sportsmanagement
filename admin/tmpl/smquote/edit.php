<?php
/**
 * Native Joomla 5/6 administrator SportsManagement quote edit layout.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
?>
<form
    action="<?php echo Route::_('index.php?option=com_sportsmanagement&view=smquote&layout=edit&id=' . $itemId); ?>"
    method="post"
    name="adminForm"
    id="smquote-form"
    class="form-validate"
>
    <?php echo HTMLHelper::_('uitab.startTabSet', 'smquote-tabs', [
        'active' => 'smquote-' . (array_key_first($fieldsets) ?: 'details'),
        'recall' => true,
        'breakpoint' => 768,
    ]); ?>
    ...
    <?php foreach ($fieldsets as $fieldsetName => $fieldset) : ?>
        ...
        ?>
        <?php echo HTMLHelper::_('uitab.addTab', 'smquote-tabs', 'smquote-' . $fieldsetName, Text::_($label !== '' ? $label : $fieldsetName)); ?>
