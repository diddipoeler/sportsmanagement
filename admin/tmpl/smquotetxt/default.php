<?php
/** Native Joomla 5/6 administrator quote source editor layout. */
...
?>
<form action="<?php echo Route::_('index.php?option=com_sportsmanagement&view=smquotetxt&layout=default'); ?>"
      method="post"
      name="adminForm"
      id="source-form"
      class="form-validate">
...
Joomla.submitbutton = function (task) {
    ...
    if (task === 'smquotetxt.cancel' || document.formvalidator.isValid(form)) {
