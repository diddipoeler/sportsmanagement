            ...
            <tr class="<?php echo "row$k"; ?>">
                ...
                <?php if ($this->saveOrder) : ?>
                	<?php if ($this->sortDirection == 'asc') : ?>
								<span><?php echo $this->pagination->orderUpIcon($i, $row->ordering - 1, 'agegroup.orderup', 'JLIB_HTML_MOVE_UP', $this->ordering); ?></span>
								<span><?php echo $this->pagination->orderDownIcon($i, $n, $row->ordering + 1, 'agegroup.orderdown', 'JLIB_HTML_MOVE_DOWN', $this->ordering); ?></span>
							<?php elseif ($this->sortDirection == 'desc') : ?>
								<span><?php echo $this->pagination->orderUpIcon($i, $row->ordering - 1, 'agegroup.orderdown', 'JLIB_HTML_MOVE_UP', $this->ordering); ?></span>
								<span><?php echo $this->pagination->orderDownIcon($i, $n, $row->ordering + 1, 'agegroup.orderup', 'JLIB_HTML_MOVE_DOWN', $this->ordering); ?></span>
							<?php endif; ?>
                <?php endif; ?>
