...
$your_array["COM_SPORTSMANAGEMENT_ADMINISTRATIVE_AREA_LEVEL_1_LONG_NAME"] = $data[0]->address->county ? $data[0]->address->county : '';
$your_array["COM_SPORTSMANAGEMENT_ADMINISTRATIVE_AREA_LEVEL_1_SHORT_NAME"] = $data[0]->address->state_district ? $data[0]->address->state_district : '';
$your_array["COM_SPORTSMANAGEMENT_ADMINISTRATIVE_AREA_LEVEL_2_LONG_NAME"] = $data[0]->address->suburb ? $data[0]->address->suburb : '';
$your_array["COM_SPORTSMANAGEMENT_ADMINISTRATIVE_AREA_LEVEL_2_SHORT_NAME"] = $data[0]->address->quarter ? $data[0]->address->quarter : '';
$your_array["COM_SPORTSMANAGEMENT_ADMINISTRATIVE_AREA_LEVEL_3_LONG_NAME"] = $data[0]->address->region ? $data[0]->address->region : '';
$your_array["COM_SPORTSMANAGEMENT_ADMINISTRATIVE_AREA_LEVEL_3_SHORT_NAME"] = $data[0]->address->city_district ? $data[0]->address->city_district : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_LEISURE"] = $data[0]->address->leisure ? $data[0]->address->leisure : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_HOUSE_NUMBER"] = $data[0]->address->house_number ? $data[0]->address->house_number : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_ROAD"] = $data[0]->address->road ? $data[0]->address->road : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_VILLAGE"] = $data[0]->address->village ? $data[0]->address->village : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_MUNICIPALITY"] = $data[0]->address->municipality ? $data[0]->address->municipality : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_COUNTY"] = $data[0]->address->county ? $data[0]->address->county : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_STATE"] = $data[0]->address->state ? $data[0]->address->state : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_INDUSTRIAL"] = $data[0]->address->industrial ? $data[0]->address->industrial : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_BUILDING"] = $data[0]->address->building ? $data[0]->address->building : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_QUARTER"] = $data[0]->address->quarter ? $data[0]->address->quarter : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_SUBURB"] = $data[0]->address->suburb ? $data[0]->address->suburb : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_CITY_DISTRICT"] = $data[0]->address->city_district ? $data[0]->address->city_district : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_CITY"] = $data[0]->address->city ? $data[0]->address->city : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_TOWN"] = $data[0]->address->town ? $data[0]->address->town : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_HAMLET"] = $data[0]->address->hamlet ? $data[0]->address->hamlet : '';
$your_array["COM_SPORTSMANAGEMENT_OSM_NEIGHBOURHOOD"] = $data[0]->address->neighbourhood ? $data[0]->address->neighbourhood : '';
