<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Clubname view.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(HtmlView::class)) {
    throw new \RuntimeException('SportsManagement native administrator Clubname view could not be loaded.', 500);
}
