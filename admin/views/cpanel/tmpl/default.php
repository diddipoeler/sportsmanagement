    ...
    <td width="55%" valign="top">			              
      <div id="cpanel">                                           
        <table class="adminlist">			                      
          <tr><td>                             
              <?php echo JText::_( 'COM_SPORTSMANAGEMENT_D_HEADING_BASIS_DATA' ).': '; ?></td>                     
          </tr>                                   
          <tr>                                      
            <td >                                          
              <div id="cpanel">                                                           
          ...
          <tr><td>                             
              <?php echo JText::_( 'COM_SPORTSMANAGEMENT_D_HEADING_SPECIAL_FUNCTION' ).': '; ?></td>                     
          </tr>                                  
          <tr>                                      
            <td >                                          
              <div id="cpanel">                                              
          ...
          <tr><td>                             
              <?php echo JText::_( 'COM_SPORTSMANAGEMENT_D_HEADING_IMPORT_EXPORT_FUNCTION' ).': '; ?></td>                     
          </tr>                                  
          <tr>                                      
            <td >                                          
              <div id="cpanel">                                              
          ...
          <tr><td>                             
              <?php echo JText::_( 'COM_SPORTSMANAGEMENT_D_HEADING_INSTALL_TOOLS' ).': '; ?></td>                     
          </tr>                                  
          <tr>                                      
            <td >                                          
              <div id="cpanel">                                              
      ...
      <table class="adminlist">				                  
        <tr>				                      
          <td width="5" style="text-align: center;">							                          
            <div style="text-align: center; width: 170px;float:left;">							                              
...
<?php
      ...
      <table class="adminlist">					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_TOTAL_USERS' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->cbe->total; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_TOTAL_BLOCKED_USERS' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->cbe->blocked; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_TOTAL_APPLICATIONS_INSTALLED' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->cbe->applications; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_TOTAL_ACTIVITY_UPDATES' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->cbe->updates; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_PHOTOS_TOTAL' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->cbe->photos; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_VIDEOS_TOTAL' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->cbe->videos; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_GROUPS_T0TAL_DISCUSSIONS' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->cbe->groupDiscussion; ?></strong>						</td>					                  
        </tr>				              
      </table>			  
<?php
				echo $this->pane->endPanel();
      ...
      <table class="adminlist">					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_GROUPS_PUBLISHED' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->groups->published; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_GROUPS_UNPUBLISHED' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
              <?php echo $this->groups->unpublished; ?></strong>						</td>					                  
        </tr>					                  
        <tr>						<td>							                          
            <?php echo JText::_( 'COM_SPORTSMANAGEMENT_GROUP_CATEGORIES' ).': '; ?>  						</td>						                      
          <td align="center">							<strong>                             
...
<?php
  ...
  <tr>		          
    ...
    <td style="text-align: center; width: 33%;">			              
      ...
      <?php echo JText::sprintf( '%1$s', $this->version ); ?>  		</td>		          
