...
?>
    <div>    
      ...
      <div class="cpanel-right">      
        ...
        <?php
        echo $this->pane->startPane( 'stat-pane' );echo $this->pane->startPanel( Text::_('COM_SPORTSMANAGEMENT_INFORMATION') , 'information' );
    ...
    if (is_array($this->importData2))
	{
        ...
        <br />
        <?php echo $this->pane->endPanel();echo $this->pane->startPanel( Text::_('COM_SPORTSMANAGEMENT_WELCOME_TO_CBECOMMUNITY') , 'welcome' );?>      
        <div style="font-weight:700;">        
          <?php echo Text::_('COM_SPORTSMANAGEMENT_GREAT_COMPONENT_MSG');?>      
        </div>
      
        <?php echo $this->pane->endPanel(); echo $this->pane->startPanel( Text::_('COM_SPORTSMANAGEMENT_STATISTICS') , 'cbe' );?>
        <?php
        if ( isset($this->cbe) )
        {
        ...
        echo $this->pane->endPanel(); echo $this->pane->startPanel( Text::_('COM_SPORTSMANAGEMENT_GROUPS_STATISTICS'), 'groups' );
        ...
        ?>
        <?php echo $this->pane->endPanel(); echo $this->pane->startPanel( Text::_('COM_SPORTSMANAGEMENT_GITHUB_REQUESTS') , 'GITHUBREQUESTS' );?>      
        <table class="adminlist">        
          <tr>            <td>            
        ...
        <?php echo $this->pane->endPanel(); echo $this->pane->startPanel( Text::_('COM_SPORTSMANAGEMENT_WELCOME_TO_FORUM') , 'FORUM' );?>      
        <table class="adminlist">        
