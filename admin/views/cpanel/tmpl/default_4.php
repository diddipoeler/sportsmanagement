    ...
    <?php
        ...
        <div id="dashboard-iconss" class="dashboard-icons">
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=sportstypes">
                <img src="components/com_sportsmanagement/assets/icons/sportarten.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_SPORTSTYPES') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=seasons">
                <img src="components/com_sportsmanagement/assets/icons/saisons.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_SEASONS') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=leagues">
                <img src="components/com_sportsmanagement/assets/icons/ligen.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_LEAGUES') ?>"/><br/>
			...
			if ($this->params->get('show_option_federation', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=jlextfederations">
                    <img src="components/com_sportsmanagement/assets/icons/federation.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_FEDERATIONS') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=jlextcountries">
                <img src="components/com_sportsmanagement/assets/icons/laender.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_COUNTRIES') ?>"/><br/>
			...
			if ($this->params->get('show_option_association', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=jlextassociations">
                    <img src="components/com_sportsmanagement/assets/icons/landesverbaende.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_ASSOCIATIONS') ?>"/><br/>
			...
			if ($this->params->get('show_option_position', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=positions">
                    <img src="components/com_sportsmanagement/assets/icons/positionen.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_POSITIONS') ?>"/><br/>
			...
			if ($this->params->get('show_option_eventtypes', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=eventtypes">
                    <img src="components/com_sportsmanagement/assets/icons/ereignisse.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_EVENTS') ?>"/><br/>
			...
			if ($this->params->get('show_option_agegroup', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=agegroups">
                    <img src="components/com_sportsmanagement/assets/icons/altersklassen.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_AGEGROUPS') ?>"/><br/>
        ...
        <div id="dashboard-iconss" class="dashboard-icons">
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=clubs">
                <img src="components/com_sportsmanagement/assets/icons/vereine.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_CLUBS') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=teams">
                <img src="components/com_sportsmanagement/assets/icons/mannschaften.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_TEAMS') ?>"/><br/>
			...
			if ($this->params->get('show_option_person', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=players">
                    <img src="components/com_sportsmanagement/assets/icons/personen.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_PERSONS') ?>"/><br/>
			...
			if ($this->params->get('show_option_playground', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=playgrounds">
                    <img src="components/com_sportsmanagement/assets/icons/spielorte.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_VENUES') ?>"/><br/>
			...
			if ($this->params->get('show_option_rosterposition', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=rosterpositions">
                    <img src="components/com_sportsmanagement/assets/icons/spielfeldpositionen.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_ROSTER_POSITION') ?>"/><br/>
        ...
        <div id="dashboard-iconss" class="dashboard-icons">
			...
			if ($this->params->get('show_option_extrafields', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=extrafields">
                    <img src="components/com_sportsmanagement/assets/icons/extrafelder.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_EXTRAFIELDS') ?>"/><br/>
			...
			if ($this->params->get('show_option_statistics', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=statistics">
                    <img src="components/com_sportsmanagement/assets/icons/statistik.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_STATISTICS') ?>"/><br/>
			...
			if ($this->params->get('show_option_clubnames', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=clubnames">
                    <img src="components/com_sportsmanagement/assets/icons/statistik.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_CLUBNAMES') ?>"/><br/>
			...
			if ($this->params->get('show_option_github', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=github">
                    <img src="components/com_sportsmanagement/assets/icons/github.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_GITHUB') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=transifex">
                <img src="components/com_sportsmanagement/assets/icons/transifex.png" width="48"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_TRANSIFEX') ?>"/><br/>
                <span><?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_TRANSIFEX') ?></span>
            </a>
        </div>

        <hr>
        <strong><i class="fa fa-2x fa-compress"></i><i
                    class="fa fa-2x fa-expand"></i> <?php echo Text::_('COM_SPORTSMANAGEMENT_D_HEADING_IMPORT_EXPORT_FUNCTION') ?>
        </strong>
        <hr>
        <div id="dashboard-iconss" class="dashboard-icons">

            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=jlxmlimports&layout=default">
                <img src="components/com_sportsmanagement/assets/icons/xmlimport.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_XML_IMPORT') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=smimageimports&layout=default">
                <img src="components/com_sportsmanagement/assets/icons/imageimport.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_IMAGE_IMPORT') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash"
               href="index.php?option=com_sportsmanagement&view=joomleagueimports&layout=default">
                <img src="components/com_sportsmanagement/assets/icons/joomleague.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_JOOMLEAGUE_IMPORT') ?>"/><br/>
        ...
        <div id="dashboard-iconss" class="dashboard-icons">
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=updates">
                <img src="components/com_sportsmanagement/assets/icons/updates.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_UPDATES') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=databasetools">
                <img src="components/com_sportsmanagement/assets/icons/datenbanktools.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_TOOLS') ?>"/><br/>
			...
			if ($this->params->get('show_option_smquotes', 1))
			{
                ...
                <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=smquotes">
                    <img src="components/com_sportsmanagement/assets/icons/zitate.png"
                         alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_D_MENU_QUOTES') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=update&task=update.save&file_name=jsm_install_jcomments_j3.php">
                <img src="components/com_sportsmanagement/assets/icons/jcomments_j4_256.png" width="50px"
                     alt="<?php echo Text::_('JComments for Joomla 3') ?>"/><br/>
                <span><?php echo Text::_('JComments for Joomla 3') ?></span>
            </a>
