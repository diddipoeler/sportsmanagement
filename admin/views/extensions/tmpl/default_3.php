								...
								foreach ($this->sporttypes as $key => $value)
								{
									switch ($value)
									{
										case 'soccer':
                                            ...
                                            <a class="btn"
                                               href="index.php?option=com_sportsmanagement&view=jlextdfbkeyimport">
										...
										case 'basketball':
											?>
                                            <a class="btn"
                                               href="index.php?option=com_sportsmanagement&view=jlextdbbimport">
										...
										case 'handball':
											?>
                                            <a class="btn"
                                               href="index.php?option=com_sportsmanagement&view=jlextsisimport">
