 ...
 * @access public
 */
class sportsmanagementViewextrafield extends JViewLegacy
{
...
//		$this->assignRef( 'extended', $extended );
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_SPORTSMANAGEMENT_EXTRAFIELD_NEW') : JText::_('COM_SPORTSMANAGEMENT_EXTRAFIELD_EDIT'), 'extrafield');
