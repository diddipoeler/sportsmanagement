...
echo 'Hier können Sie die Wappen zu den Ligen hinterlegen. <br>';


//echo JPATH_COMPONENT.'<br>';


$myForm = new Form('leaguelogohistory');
$myForm->addFormPath(JPATH_COMPONENT . '/models/forms');
$myForm->loadFile('leaguelogohistory', false);
...
var body = jQuery("#leaguelogos").find('tbody');
...
<!--
<input type="button" value="Neues Logo hinzufügen" onclick="addRows()" />
-->

<table class="table table-striped" id="leaguelogos">
  <thead>
    <tr>
