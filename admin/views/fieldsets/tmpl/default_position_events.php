...
<fieldset class="adminform">
    ...
    <table class="admintable">
        <tr>
            <td style="width:auto;"><b><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_POSITION_EXISTING_EVENTS'); ?></b><br/><?php echo $this->lists['events']; ?>
            </td>
            <td style="width:auto;">
            ...
            <td style="width:auto;">
                <b><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_POSITION_ASSIGNED_EVENTS_TO_POS'); ?></b><br/><?php echo $this->lists['position_events']; ?>
            </td>
