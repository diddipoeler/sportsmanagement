...
<fieldset class="adminform">
	...
	<table class="admintable">
		<tr>
			<td style="width:auto;"><b><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_POSITION_EXISTING_STATISTICS'); ?></b><br /><?php echo $this->lists['statistic']; ?></td>
			<td style="width:auto;">
			...
			<td style="width:auto;"><b><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_POSITION_ASSIGNED_STATS_TO_POS'); ?></b><br /><?php echo $this->lists['position_statistic']; ?></td>
