...
?>
    ...
    <div class="container-popup">
        ...
        <fieldset class='adminform'>
            ...
            <form action="<?php echo Route::_('index.php?option=com_sportsmanagement'); ?>" id='addissue-form'
                ...
                <table class='table'>
                    ...
                    <tr>
                        <td colspan="2">
							...
							?>
                            <input type="text" name="title" id="title" value="<?php echo $this->issuetitle; ?>"
                                   class="form-control form-control-inline" size="100" maxlength="100" required="">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
							...
							?>
                            <div role="application" aria-labelledby="jform_projectinfo_voice"
                                 id="jform_projectinfo_parent" class="mceEditor defaultSkin">
                                <textarea id="message" name="message" cols="" rows="" style="width:80%;height:200px;"
                                          class="wfEditor mce_editable source" wrap="off"></textarea>
                            </div>
                        </td>
                    </tr>
                    </tbody>
