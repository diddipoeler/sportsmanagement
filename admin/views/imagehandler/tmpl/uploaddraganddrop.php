...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/<?php echo $bootstrap_fileinput_version; ?>/js/plugins/piexif.min.js"
        type="text/javascript"></script>
<!-- sortable.min.js is only needed if you wish to sort / rearrange files in initial preview.
	This must be loaded before fileinput.min.js -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/<?php echo $bootstrap_fileinput_version; ?>/js/plugins/sortable.min.js"
        type="text/javascript"></script>
<!-- purify.min.js is only needed if you wish to purify HTML content in your preview for
	HTML files. This must be loaded before fileinput.min.js -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/<?php echo $bootstrap_fileinput_version; ?>/js/plugins/purify.min.js"
        type="text/javascript"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/<?php echo $bootstrap_fileinput_version; ?>/js/fileinput.min.js"></script>
<!-- following theme script is needed to use the Font Awesome 5.x theme (`fas`) -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/<?php echo $bootstrap_fileinput_version; ?>/themes/fas/theme.min.js"></script>
<!-- optionally if you need translation for your language then include the locale file as mentioned below (replace LANG.js with your language locale) -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/<?php echo $bootstrap_fileinput_version; ?>/js/locales/<?php echo $languageCode; ?>.js"></script>
