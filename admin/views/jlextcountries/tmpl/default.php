			...
			<tbody>
				...
				for ($i=0,$n=count($this->items); $i < $n; $i++)
				{
					...
					<tr class="<?php echo "row$k"; ?>">
						...
						<td class="order">
							<span>
								<?php echo $this->pagination->orderUpIcon($i,$i > 0,'jlextcountry.orderup','JLIB_HTML_MOVE_UP',$ordering); ?>
							</span>
							<span>
								<?php echo $this->pagination->orderDownIcon($i,$n,$i < $n,'jlextcountry.orderdown','JLIB_HTML_MOVE_DOWN',$ordering); ?>
