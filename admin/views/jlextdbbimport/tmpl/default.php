...
<div id="editcell">
	<form enctype='multipart/form-data' method='post' name="adminForm">
		<table class='adminlist'>
			...
			<tfoot>
			  <tr>
				...
				<?php
				echo '<br />';
				echo '<b>'.JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_EXTENTION_INFO').'</b><br />';
				echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_HINT1').'<br />';
				echo JText::sprintf('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_HINT2',$this->revisionDate);
				/*
				$linkParams=array();
      ...
      <legend>
				<?php
				echo JText::_( 'COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_SELECT_USE_PROJECT');
				?>
			</legend>      
      <input class='input_box' type='checkbox' id='dfbimportupdate' name='dfbimportupdate'  /><?php echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_USE_PROJECT'); ?>      
      </fieldset>
      </td>
      </tr>
      <?php
      ...
      <legend>
				<?php
				echo JText::_( 'COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_WHICH_FILE');
				?>
			</legend>
      <input type="radio" name="whichfile" value="playerfile" > <?PHP echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_PLAYERFILE'); ?><br><br>
      <input type="radio" name="whichfile" value="matchfile"> <?PHP echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_MATCHFILE'); ?><br><br>
      <input type="radio" name="whichfile" value="icsfile" checked> <?PHP echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_ICSFILE'); ?><br>
      </fieldset>
      </td>
      </tr>
      ...
      <legend>
				<?php
				echo JText::_( 'COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_DELIMITER' );
				?>
			</legend>
			
      <input type="radio" name="delimiter" value=";" checked> <?PHP echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_DELIMITER_SEMICOLON'); ?><br><br>
      <input type="radio" name="delimiter" value=","> <?PHP echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_DELIMITER_COMMA'); ?><br><br>
      <input type="radio" name="delimiter" value="\t"> <?PHP echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_DELIMITER_TABULAR'); ?><br>
      </fieldset>
      </td>
      </tr>
      <?php
      ...
      <fieldset>
            <legend>
				<?php
				echo JText::_( 'COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_FILE' );
				?>
			</legend>

				<input class="input_box" id="import_package" name="import_package" type="file" size="57" />
				<input class="button" type="submit" onclick="return Joomla.submitform('jlextdbbimport.save')" value="<?php echo JText::_('COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT_UPLOAD_BUTTON'); ?>" />
			</fieldset>
      </td>
      </tr>
      </tbody>
