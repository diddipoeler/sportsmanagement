...
class sportsmanagementViewjlextdbbimport extends JView 
{
    ...
    private function _displayInfo($tpl) {
		...
		// Set toolbar items for the page
		// JToolBarHelper::title(JText::_('COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_TITLE_3_3'),'generic.png');
		// JToolBarHelper::back();
		// JToolBarHelper::help('screen.joomleague',true);
    ...
    */
	...
	private function _displaySelectpage($tpl) {
		...
		switch ($this->selectType) {
			case '8' :
				{ // Select Statistics
					...
					$statisticlist = array ();
					$statisticlist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_SELECT_STATISTIC' ) );
			...
			case '7' :
				{ // Select ParentPosition
					...
					$parentpositionlist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_SELECT_PARENT_POSITION' ) );
			...
			case '6' :
				{ // Select Position
					...
					$positionlist = array ();
					$positionlist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_SELECT_POSITION' ) );
			...
			case '5' :
				{ // Select Event
					...
					$eventlist = array ();
					$eventlist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_SELECT_EVENT' ) );
			...
			case '4' :
				{ // Select Playground
					...
					$playgroundlist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_SELECT_PLAYGROUND' ) );
			...
			case '3' :
				{ // Select Person
					...
					$personlist = array ();
					$personlist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_SELECT_PERSON' ) );
			...
			case '2' :
				{ // Select Club
					...
					$clublist = array ();
					$clublist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_SELECT_CLUB' ) );
			...
			default :
				{ // Select Team
					...
					$this->assignRef ( 'clubs', $model->getClubListSelect () );
					$teamlist = array ();
					$teamlist [] = JHtml::_ ( 'select.option', 0, JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBBIMPORT_SELECT_TEAM' ) );
		...
		$this->assignRef ( 'lists', $lists );
		// Set page title
		$pageTitle = JText::_ ( 'COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_ASSIGN_TITLE' );
    ...
    */
	...
	protected function addToolbar() {
		...
		//JToolBarHelper::custom('jlextdfbnetplayerimport.save','upload','upload',JText::_('COM_JOOMLEAGUE_ADMIN_DBB_IMPORT_UPLOAD_BUTTON'),false);
        ...
        // Set toolbar items for the page
		JToolBarHelper::title( JText::_( 'COM_SPORTSMANAGEMENT_ADMIN_DBB_IMPORT' ),'dfbnet' );
