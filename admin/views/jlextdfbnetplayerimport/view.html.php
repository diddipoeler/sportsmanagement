 ...
 * @access public
 */
class sportsmanagementViewjlextdfbnetplayerimport extends JView 
{
    ...
    */
	...
	protected function addToolbar() {
		...
		//JToolBarHelper::custom('jlextdfbnetplayerimport.save','upload','upload',JText::_('COM_JOOMLEAGUE_ADMIN_DFBNET_IMPORT_UPLOAD_BUTTON'),false);
