...
<div class="table-responsive" id="editcell">
    <table class="<?php echo $this->table_data_class; ?>">
		...
		{
			$link       = Route::_('index.php?option=com_sportsmanagement&task=jlextfederation.edit&id=' . $this->item->id);
            ...
            <tr class="row<?php echo $this->count_i % 2; ?>" <?php echo $this->dragable_group; ?>>
                ...
                <td style="text-align:center; ">
					<?php if ($this->item->checked_out) : ?>
						<?php echo HTMLHelper::_('jgrid.checkedout', $this->count_i, $this->item->editor, $this->item->checked_out_time, 'jlextfederations.', $canCheckin); ?>
					<?php endif; ?>
					<?php if ($canEdit) : ?>
                        <a href="<?php echo Route::_('index.php?option=com_sportsmanagement&task=jlextfederation.edit&id=' . (int) $this->item->id); ?>">
                ...
                <td class="center">
                    <div class="btn-group">
						...
						if ($canChange)
						{
							HTMLHelper::_('actionsdropdown.' . ((int) $this->item->published === 2 ? 'un' : '') . 'archive', 'cb' . $this->count_i, 'jlextfederations');
							HTMLHelper::_('actionsdropdown.' . ((int) $this->item->published === -2 ? 'un' : '') . 'trash', 'cb' . $this->count_i, 'jlextfederations');
