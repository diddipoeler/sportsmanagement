                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style='text-align:left; vertical-align:top; '>
                                                    <input type='text' name='tempaddmatchescount'
                                                           id='tempaddmatchescount' value='0' size='3'
                                                           class='inputbox'/>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style='text-align:left; vertical-align:top; '><input type='text'
                                                                                                         name='firstMatchNumber'
                                                                                                         size='4'
                                                                                                         value=''/></td>
                                            </tr>
                                            <tr>
                        ...
                        <table border='0'>
                            <tr>
                                <td valign="top" align="right">
                                    <b><?php echo Text::_('COM_SPORTSMANAGEMENT_MATCHES_MASSADD_COPY2'); ?></b></td>
                                <td valign="top" align="left"><?php echo $this->lists['project_rounds2']; ?></td>
                            </tr>
                            <tr>
                                <td valign="top" align="right">
                                    <b><?php echo Text::_('COM_SPORTSMANAGEMENT_MATCHES_MASSADD_DEFAULT_DATE'); ?></b>
                                </td>
                                <td>
									<?php
									echo HTMLHelper::calendar(
									...
									?>
                                    &nbsp;
                                    <input type='text' name='time' value='<?php echo $this->projectws->start_time; ?>'
                                           size='4' maxlength='5' class='inputbox'/>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" align="right">
                                    <b><?php echo Text::_('COM_SPORTSMANAGEMENT_MATCHES_MASSADD_FIRST_MATCHNR'); ?></b>
                                </td>
                            ...
                            <tr>
                                <td valign="top" align="right"><b>
                                        <acronym
                                                title="<?php echo Text::_('COM_SPORTSMANAGEMENT_MATCHES_MASSADD_ACRONYM_CREATE_NEW'); ?>">
											<?php echo Text::_('COM_SPORTSMANAGEMENT_MATCHES_MASSADD_CREATE_NEW'); ?>
                                        </acronym></b>
                                </td>
                                <td><input type="checkbox" name="create_new" value="1" class="inputbox"
                                           checked="checked"/></td>
                            </tr>
                            <tr>
                                <td valign="top" align="right"><b>
                                        <acronym
                                                title="<?php echo Text::_('COM_SPORTSMANAGEMENT_MATCHES_MASSADD_ACRONYM_MIRROR'); ?>">
                                ...
                                <td>
                                    <select name="mirror" class="inputbox">
                                        <option value="0"
                                                selected="selected"><?php echo Text::_('COM_SPORTSMANAGEMENT_MATCHES_MASSADD_COPY_MATCHES'); ?></option>
