					...
					<tbody>
						<tr>
							<td valign='top' width='40%'>
								<table border='0'>
									<tr>
										<td style='text-align:right; vertical-align:top; font-weight:bold; '><?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_TYPE'); ?></td>
									...
									<tr>
										<td colspan='2' >
											<div id='massadd_standard' style='display:block;'>
												<table>
													<tr>
														<td style='text-align:right; vertical-align:top; font-weight:bold; '><?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_NR'); ?></td>
														<td style='text-align:left; vertical-align:top; '>
															<input type='text' name='tempaddmatchescount' id='tempaddmatchescount' value='0' size='3' class='inputbox' />
														</td>
													</tr>
													<tr>
														<td style='text-align:right; vertical-align:top; font-weight:bold; '><?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_START_HERE'); ?></td>
														<td style='text-align:left; vertical-align:top; '><?php echo $this->lists['addToRound']; ?></td>
													</tr>
													<tr>
														<td style='text-align:right; vertical-align:top; font-weight:bold; '><?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_AUTO_PUBL'); ?></td>
														<td style='text-align:left; vertical-align:top; '><?php echo $this->lists['autoPublish']; ?></td>
													</tr>
													<tr>
														<td style='text-align:right; vertical-align:top; font-weight:bold; '><?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_FIRST_MATCHNR'); ?></td>
							...
							<td valign='top'>
								<table border='0'>
									<tr>
										<td valign="top" align="right"><b><?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_COPY2'); ?></b></td>
									...
									<tr>
										<td valign="top" align="right"><b><?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_FIRST_MATCHNR'); ?></b></td>
										<td><input type="text" name="start_match_number" size="4" value="" /></td>
									</tr>
									<tr>
										<td valign="top" align="right"><b>
											<acronym title="<?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_ACRONYM_CREATE_NEW'); ?>">
									...
									<tr>
										<td valign="top" align="right"><b>
											<acronym title="<?php echo JText::_('JL_ADMIN_MATCHES_MASSADD_ACRONYM_MIRROR'); ?>">
