...
if (isset($this->xml) && is_array($this->xml))
{
	...
	if (!empty($teamsClubs))
	{
		$teamsClubsCount = count($teamsClubs);
	}
	?>
    <script>
    ...
    <div id='editcell'>
        ...
        <table class='adminlist'>
            <thead>
            <tr>
                <th><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_TABLE_TITLE_2'); ?></th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td style='text-align:center; '>
                    <p style='text-align:center;'><b
                                style='color:green; '><?php echo Text::sprintf('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_UPLOAD_SUCCESS', '<i>' . $this->uploadArray['name'] . '</i>'); ?></b>
                    </p>
					<?php
    ...
    <form name='adminForm' id='adminForm' action='<?php echo $this->request_url; ?>' method='post' onsubmit=''>
		...
		if (($xmlProjectImport) || ($xmlImportType == 'events') || ($xmlImportType == 'positions'))
		{
            ...
            <fieldset>
                <legend>
                    <strong><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_GENERAL_DATA_LEGEND'); ?></strong>
                </legend>
                <table class='adminlist'>
					<?php
					if (($xmlImportType != 'events') && ($xmlImportType != 'positions'))
					{
                        ...
                        <tr>
                            ...
                            <td style='background-color:#EEEEEE'>
                                <input type='text' name='name' id='name' size='110' maxlength='100'
                                       value="<?php echo stripslashes(htmlspecialchars($proj->name)); ?>"/>
                            </td>
                        </tr>
						<?php
					}
                    ...
                    <tr>
                        ...
                        <td style='background-color:#DDDDDD'>
							...
							if (count($this->sportstypes) > 0)
							{
								...
								?>
                                <select name='sportstype' id='sportstype' <?php if (!$foundMatchingSportstype)
								{
									echo " disabled='disabled'";
								} ?>>
                                    <option selected
                                            value="0"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_SPORTSTYPE_SELECT'); ?></option>
									<?php echo $options; ?>
                                </select>
                                <br/>
                                <input type='checkbox' name='newSportsTypeCheck' value="1"
									<?php if (!$foundMatchingSportstype)
									{
                        ...
                        <tr>
                            ...
                            <td style='background-color:#EEEEEE'>
                                ...
                                <input type='radio' name='publish' value="1"
                                       checked='checked'/><?php echo Text::_('JYES'); ?>
                            </td>
                        </tr>
						<?php
					}
            ...
            <p style='text-align:right;'><a
                        href='#page_bottom'><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_BOTTOM'); ?></a>
            </p>
            <p style='text-align:right;'>
                <button type="button"
                        onclick="Joomla.submitbutton('jlxmlimport.insert')"><?php echo Text::_('JSAVE') ?></button>
            </p>
			<?php
		}
		?>
		...
		if ((isset($clubs) && count($clubs) > 0) || (isset($teams) && count($teams) > 0))
		{
            ...
            <fieldset>
                ...
                <table class='adminlist'>
					...
					foreach ($teamsClubs AS $key => $teamClub)
					{
                        ...
                        <tr>
                            <td nowrap='nowrap'
                                style='text-align:center; vertical-align:middle; background-color:<?php echo $color; ?>'>
                                &nbsp;
                            </td>
							<?php $color = $foundMatchingClubAndTeam ? $useExistingEntryColor : $useNewEntryColor; ?>
                            <td style='line-height:200%; text-align:left; vertical-align:middle; background-color:<?php echo $color; ?>'
                                id='tetd<?php echo $key; ?>'>
								<?php
								if ($foundMatchingClubAndTeam)
								{
            ...
            -->
                                <input type='radio' name='cto_<?php echo $i; ?>' id='ecet_<?php echo $i; ?>'
            ...
            -->
                                <input type='radio' name='cto_<?php echo $i; ?>' id='ecnt_<?php echo $i; ?>'
            ...
            -->
                                <input type='radio' name='cto_<?php echo $i; ?>' id='ncnt_<?php echo $i; ?>'
                            ...
                            <td style='text-align:left; vertical-align:top; background-color:<?php echo $color; ?>'>
                                <table cellpadding='0' cellspacing='0'
                                       style='border-color:<?php echo $color; ?>; border-width:0; border-style:none'>
                                    <thead>
                                    ...
                                    <tr style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>; border-style:none'>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            ...
                                            <input type='<?php echo $visible; ?>'
                                                   name='matching_ClubID_<?php echo $key; ?>'
                                                   value='<?php echo $matchingClub_ID; ?>'/>
                                            <input type='<?php echo $visible; ?>' name='clubID_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_ClubID; ?>' <?php echo $ic_disabled; ?>/>
                                            <input type='<?php echo $visible; ?>' name='clubName_<?php echo $key; ?>'
                                                   size='60' maxlength='100'
                                                   value='<?php echo stripslashes(htmlspecialchars($importTeam_ClubName)); ?>' <?php echo $ic_disabled; ?>/>
                                            <input type='<?php echo $visible; ?>' name='clubFileID_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_ClubID; ?>'/>
                                            <input type='<?php echo $visible; ?>' name='clubCountry_<?php echo $key; ?>'
                                                   size='60' maxlength='100'
                                                   value='<?php echo stripslashes(htmlspecialchars($importTeam_ClubCountry)); ?>' <?php echo $ic_disabled; ?>/>

                                            <input type='<?php echo $visible; ?>' name='dbClubID_<?php echo $key; ?>'
                                                   value='<?php echo $matchingClub_ID; ?>' <?php echo $dc_disabled; ?>/>
                                            <input type='<?php echo $visible; ?>'
                                                   name='dbClubPlaygroundID_<?php echo $key; ?>'
                                                   value='<?php echo $matchingClub_PlaygroundID; ?>'/>
                                        </td>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='impClubName_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_ClubName; ?>' size='30' maxlength='45'
                                                   disabled='disabled'>
                                        </td>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            &nbsp;
                                        ...
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='dbClubName_<?php echo $key; ?>' size='30'
                                                   maxlength='45' disabled='disabled'
                                    ...
                                    <tr style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>; border-style:none'>
                                        ...
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='impClubCountry_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_ClubCountry; ?>' size='30'
                                                   maxlength='45' disabled='disabled'>
                                        </td>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            &nbsp;
                                        ...
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='dbClubCountry_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_ClubCountry; ?>' size='30'
                                                   maxlength='45' disabled='disabled'>
                                        </td>
                                    </tr>
                                    <tr style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>; border-style:none'>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='hidden' name='matching_TeamID_<?php echo $key; ?>'
                                                   value='<?php echo $matchingTeam_ID; ?>' <?php echo $it_disabled; ?>/>
                                            <input type='hidden' name='teamID_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_ID; ?>' <?php echo $it_disabled; ?>/>
                                            <input type='hidden' name='teamFileID_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_ID; ?>' <?php echo $it_disabled; ?>/>
                                            <input type='hidden' name='teamName_<?php echo $key; ?>' size='60'
                                                   maxlength='100'
                                                   value='<?php echo stripslashes(htmlspecialchars($importTeam_Name)); ?>' <?php echo $it_disabled; ?>/>
                                            <input type='hidden' name='teamShortname_<?php echo $key; ?>' size='60'
                                                   maxlength='100'
                                                   value='<?php echo stripslashes(htmlspecialchars($importTeam_ShortName)); ?>' <?php echo $it_disabled; ?>/>
                                            <input type='hidden' name='teamMiddleName_<?php echo $key; ?>' size='60'
                                                   maxlength='100'
                                                   value='<?php echo stripslashes(htmlspecialchars($importTeam_MiddleName)); ?>' <?php echo $it_disabled; ?>/>
                                            <input type='hidden' name='teamInfo_<?php echo $key; ?>' size='60'
                                                   maxlength='255'
                                                   value='<?php echo stripslashes(htmlspecialchars($importTeam_Info)); ?>' <?php echo $it_disabled; ?>/>
                                            <input type='hidden' name='dbTeamID_<?php echo $key; ?>'
                                                   value='<?php echo $matchingTeam_ID; ?>' <?php echo $dt_disabled; ?>/>
                                            <b><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_TEAMNAME'); ?></b>
                                        </td>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='impTeamName_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_Name; ?>' size='30' maxlength='45'
                                                   disabled='disabled'/>
                                        </td>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            &nbsp;
                                        ...
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='dbTeamName_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_Name; ?>' size='30' maxlength='45'
                                                   disabled='disabled'/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>; border-style:none'>
                                        ...
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='impTeamInfo_<?php echo $key; ?>'
                                                   value='<?php echo $importTeam_Info; ?>' size='30' maxlength='45'
                                                   disabled='disabled'/>
                                        </td>
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            &nbsp;
                                        ...
                                        <td style='background-color:<?php echo $color; ?>; border-color:<?php echo $color; ?>'>
                                            <input type='text' name='dbTeamInfo_<?php echo $key; ?>'
                                                   value='<?php echo $matchingTeam_INFO; ?>' size='30' maxlength='45'
                                                   disabled='disabled'/>
                                        </td>
                                    </tr>
            ...
            <p style='text-align:right;'><a
                        href='#page_top'><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_TOP'); ?></a></p>
            <p style='text-align:right;'>
                <button type="button"
                        onclick="Joomla.submitbutton('jlxmlimport.insert')"><?php echo Text::_('JSAVE') ?></button>
            </p>
					...
					foreach ($playgrounds AS $key => $playground)
					{
                        ...
                        <tr>
                            <td style='text-align:center; vertical-align:middle; background-color:<?php echo $color; ?>'>
                                <input type='checkbox' value="<?php echo $key; ?>" name='plid[]'
                                       id='pl<?php echo $i; ?>'
                                       onchange='testPlaygroundData(this,<?php echo $key; ?>)'/>
                            </td>
							<?php
							...
							?>
                            <td width='45%' style='text-align:left; background-color:<?php echo $color; ?>'
                                id='pltd<?php echo $key; ?>'>
								<?php
                                ...
                                <table cellspacing='0' cellpadding='0'>
                                    <tr>
                                        <td>
                                            ...
                                            <input type='hidden' name='playgroundID_<?php echo $key; ?>'
                                                   value="<?php echo $key; ?>" <?php echo $disabled; ?> />
                                            <input type='text' name='playgroundName_<?php echo $key; ?>' size='45'
                                                   maxlength='45'
                                                   value="<?php echo stripslashes(htmlspecialchars($playground->name)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td>
											<?php echo '<b>' . Text::_('Shortname') . '</b>'; ?><br/>
                                            <input type='text' name='playgroundShortname_<?php echo $key; ?>' size='20'
                                                   maxlength='15'
                                                   value="<?php echo stripslashes(htmlspecialchars($playground->short_name)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td>
											<?php echo '<b>' . Text::_('Country') . '</b>'; ?><br/>
                                            <input type='text' name='playgroundCountry_<?php echo $key; ?>' size='20'
                                                   maxlength='15'
                                                   value="<?php echo stripslashes(htmlspecialchars($playground->country)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <fieldset>
                ...
                <table class='adminlist'>
					...
					foreach ($events AS $key => $event)
					{
                        ...
                        <tr>
                            <td style='text-align:center; vertical-align:middle; background-color:<?php echo $color; ?>'>
                                <input type='checkbox' value="<?php echo $key; ?>" name='evid[]'
                                       id='ev<?php echo $i; ?>' onchange='testEventsData(this,<?php echo $key; ?>)'/>
                            </td>
							<?php
                                ...
                                <table cellspacing='0' cellpadding='0'>
                                    <tr>
                                        <td>
                                            ...
                                            <input type='hidden' name='eventID_<?php echo $key; ?>'
                                                   value="<?php echo $key; ?>" <?php echo $disabled; ?> />
                                            <input type='text' name='eventName_<?php echo $key; ?>' size='75'
                                                   maxlength='75'
                                                   value="<?php echo stripslashes(htmlspecialchars($event->name)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <fieldset>
                ...
                <table class='adminlist'>
					...
					foreach ($parentpositions AS $key => $parentposition)
					{
                        ...
                        <tr>
                            <td style='text-align:center; vertical-align:middle; background-color:<?php echo $color; ?>'>
                                <input type='checkbox' value="<?php echo $key; ?>" name='ppid[]'
                                       id='pp<?php echo $i; ?>'
                                       onchange='testParentPositionsData(this,<?php echo $key; ?>)'/>
                            </td>
							<?php
                                ...
                                <table cellspacing='0' cellpadding='0'>
                                    <tr>
                                        <td>
                                            ...
                                            <input type='hidden' name='parentPositionID_<?php echo $key; ?>'
                                                   value="<?php echo $key; ?>" <?php echo $disabled; ?> />
                                            <input type='text' name='parentPositionName_<?php echo $key; ?>' size='75'
                                                   maxlength='75'
                                                   value="<?php echo stripslashes(htmlspecialchars($parentposition->name)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                    </tr>
                                </table>
                            </td>
		...
		if (isset($positions) && (is_array($positions) && count($positions) > 0))
		{
			?>
            <fieldset>
                <legend><strong><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_POS_ASSIGNMENT'); ?></strong>
                </legend>
                <table class='adminlist'>
                    <thead>
                    <tr>
					...
					foreach ($positions AS $key => $position)
					{
                        ...
                        <tr>
                            <td style='text-align:center; vertical-align:middle; background-color:<?php echo $color; ?>'>
                                <input type='checkbox' value="<?php echo $key; ?>" name='poid[]'
                                       id='po<?php echo $i; ?>' onchange='testPositionsData(this,<?php echo $key; ?>)'/>
                            </td>
							<?php
                                ...
                                <table cellspacing='0' cellpadding='0'>
                                    <tr>
                                        <td>
                                            ...
                                            <input type='hidden' name='positionID_<?php echo $key; ?>'
                                                   value="<?php echo $key; ?>" <?php echo $disabled; ?> />
                                            <input type='text' name='positionName_<?php echo $key; ?>' size='75'
                                                   maxlength='75'
                                                   value="<?php echo stripslashes(htmlspecialchars($position->name)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <fieldset>
                ...
                <table class='adminlist'>
					...
					foreach ($statistics AS $key => $statistic)
					{
                        ...
                        <tr>
                            <td style='text-align:center; vertical-align:middle; background-color:<?php echo $color; ?>'>
                                <input type='checkbox' value="<?php echo $key; ?>" name='stid[]'
                                       id='st<?php echo $i; ?>'
                                       onchange='testStatisticsData(this,<?php echo $key; ?>)'/>
                            </td>
							<?php
                                ...
                                <table cellspacing='0' cellpadding='0'>
                                    <tr>
                                        <td>
                                            ...
                                            <input type='hidden' name='statisticID_<?php echo $key; ?>'
                                                   value="<?php echo $key; ?>" <?php echo $disabled; ?> />
                                            <input type='text' name='statisticName_<?php echo $key; ?>' size='100'
                                                   maxlength='75'
                                                   value="<?php echo stripslashes(htmlspecialchars($statistic->name)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                    </tr>
                                </table>
                            </td>
		...
		if (isset($persons) && (is_array($persons) && count($persons) > 0))
		{
			?>
            <fieldset>
                <legend><strong><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_PERSON_LEGEND'); ?></strong>
                </legend>
                <table class='adminlist'>
                    <thead>
                    <tr>
					...
					foreach ($persons AS $key => $person)
					{
                        ...
                        <tr>
                            <td style='text-align:center; vertical-align:middle; background-color:<?php echo $color; ?>'>
                                <input type='checkbox' value="<?php echo $key; ?>" name='peid[]'
                                       id='pe<?php echo $i; ?>' onchange='testPersonsData(this,<?php echo $key; ?>)'/>
                            </td>
							<?php
                            ...
                            <td width='45%' style='text-align:left; background-color:<?php echo $color; ?>'
                                ...
                                <table cellspacing='0' cellpadding='0'>
                                    <tr>
                                        <td><?php echo '<b>' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_LNAME') . '</b>'; ?>
                                            <br/>
                                            <input type='hidden' name='personID_<?php echo $key; ?>'
                                                   value="<?php echo $key; ?>" <?php echo $disabled; ?> />
                                            <input type='text' name='personLastname_<?php echo $key; ?>' size='30'
                                                   maxlength='45'
                                                   value="<?php echo stripslashes(htmlspecialchars($person->lastname)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td><?php echo '<b>' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_FNAME') . '</b>'; ?>
                                            <br/>
                                            <input type='text' name='personFirstname_<?php echo $key; ?>' size='30'
                                                   maxlength='45'
                                                   value="<?php echo stripslashes(htmlspecialchars($person->firstname)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td><?php echo '<b>' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_NNAME') . '</b>'; ?>
                                            <br/>
                                            <input type='text' name='personNickname_<?php echo $key; ?>' size='30'
                                                   maxlength='45'
                                                   value="<?php echo stripslashes(htmlspecialchars($person->nickname)); ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td><?php echo '<b>' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_BIRTHDAY') . '</b>'; ?>
                                            <br/>
                                            <input type='text' name='personBirthday_<?php echo $key; ?>' maxlength='10'
                                                   size='11'
                                                   value="<?php echo $person->birthday; ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td><?php echo '<b>' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_INFO') . '</b>'; ?>
                                            <br/>
                                            <input type='text' name='personInfo_<?php echo $key; ?>' maxlength='50'
                                                   size='50'
                                                   value="<?php echo $person->info; ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td><?php echo '<b>' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_XML_IMPORT_KNVBNR') . '</b>'; ?>
                                            <br/>
                                            <input type='text' name='personKnvbnr_<?php echo $key; ?>' maxlength='10'
                                                   size='10'
                                                   value="<?php echo $person->knvbnr; ?>" <?php echo $disabled; ?> />
                                        </td>
                                        <td>
											<?PHP
											$agegroup = 0;
