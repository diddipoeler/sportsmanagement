                ...
                <div class="control-group">
                    <div class="control-label">
                        <label id="jform_name-lbl" for="user"
                               ...
                               aria-invalid="true"><?php echo Text::_('COM_GCALENDAR_VIEW_LOGIN_AUTH_DEFAULT_FIELD_NAME'); ?>
                            <span
                ...
                <div class="control-group">
                    <div class="control-label">
                        <label id="jform_name-lbl" for="pass"
                               class="hasTip required invalid" title=""
                               aria-invalid="true"><?php echo Text::_('COM_GCALENDAR_VIEW_LOGIN_AUTH_DEFAULT_FIELD_PASSWORD'); ?>
                            <span
                                    class="star">&nbsp;*</span> </label>
                    </div>
                    <div class="controls">
