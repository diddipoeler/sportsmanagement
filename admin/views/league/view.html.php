 ...
 * @access public
 */
class sportsmanagementViewLeague extends JViewLegacy
{
	...
	protected function setDocument() 
	{
		$isNew = $this->item->id == 0;
		$document = JFactory::getDocument();
		$document->setTitle($isNew ? JText::_('COM_SPORTSMANAGEMENT_ADMIN_LEAGUE_ADD_NEW') : JText::_('COM_SPORTSMANAGEMENT_ADMIN_LEAGUE_EDIT'));
