...
<div id="editcell">
    <form enctype='multipart/form-data' action='<?php echo $this->request_url; ?>' method='post' id='adminForm'
        ...
        <table class='adminlist'>
            <thead>
            <tr>
                <th><?php echo Text::sprintf('COM_SPORTSMANAGEMENT_ADMIN_PRESSEBERICHT_IMPORT_TABLE_TITLE_1', $this->config->get('upload_maxsize')); ?></th>
            </tr>
            </thead>
            <tfoot>
            <tr>
                ...
                <td>
                    <fieldset style='text-align: center; '>
                        ...
                        <input class='button' type='submit'
                               value='<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_PRESSEBERICHT_IMPORT_UPLOAD_BUTTON'); ?>'/>
                    </fieldset>
                </td>
            </tr>
            </tbody>
