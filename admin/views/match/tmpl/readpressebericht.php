...
<div class="container">
    <form action="<?php echo $this->request_url; ?>" method="post" id="adminForm" name="adminForm">
        ...
        <table id="csvplayers" class="table table-hover table-responsive" width="" border="" cellspacing=""
               cellpadding="" bgcolor="">
            <thead>
            <tr>
			...
			<?php foreach ($this->csvreferees as $value)
                ...
                <tr>
                    <td>
                        ...
                        <input type='hidden' name='referee[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->csv_position; ?>'/>
                        <input type='hidden' name='refereepersonid[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->person_id; ?>'/>
                        <input type='hidden' name='refereeprojectrefereeid[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->project_referee_id; ?>'/>
                    </td>
                    <td>
						<?php echo $value->firstname; ?>
                        <input type='hidden' name='refereefirstname[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->firstname; ?>'/>
                    </td>
                    <td>
						<?php echo $value->lastname; ?>
                        <input type='hidden' name='refereelastname[<?php echo $lfdnummer; ?>]'
                ...
                <tr>
                    <td><?php echo $value->nummer; ?>
                        ...
                        <input type='hidden' name='playerpersonid[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->person_id; ?>'/>
                        <input type='hidden' name='playerprojectpersonid[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->project_person_id; ?>'/>
                        <input type='hidden' name='playerprojectpositionid[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->project_position_id; ?>'/>
                        <input type='hidden' name='playerhinweis[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->hinweis; ?>'/>
                    </td>
                    <td><?php echo $value->firstname; ?>
                        <input type='hidden' name='playerfirstname[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->firstname; ?>'/>
                    </td>
                    <td><?php echo $value->lastname; ?>
                        <input type='hidden' name='playerlastname[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->lastname; ?>'/>
                    </td>
                    <td>
						<?php
        ...
        <table id="csvstaff" class="table table-hover table-responsive" width="" border="" cellspacing="" cellpadding=""
               bgcolor="">
            <thead>
            <tr>
			...
			<?php foreach ($this->csvstaff as $value)
                ...
                <tr>
                    <td>
                        ...
                        <input type='hidden' name='staffprojectpersonid[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->project_person_id; ?>'/>
                        <input type='hidden' name='staffprojectpositionid[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->project_position_id; ?>'/>
                    </td>
                    <td>
						<?php echo $value->firstname; ?>
                        <input type='hidden' name='stafffirstname[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->firstname; ?>'/>
                    </td>
                    <td>
						<?php echo $value->lastname; ?>
                        <input type='hidden' name='stafflastname[<?php echo $lfdnummer; ?>]'
                               value='<?php echo $value->lastname; ?>'/>
                    </td>
                    <td>
						<?php
        ...
        <table id="csvinout" class="table table-hover table-responsive" width="" border="" cellspacing="" cellpadding=""
               bgcolor="">
            <thead>
            <tr>
                <th class="">Spieler</th>
        ...
        <h2>Karten</h2>
        <table id="csvcards" class="table table-hover table-responsive" width="" border="" cellspacing="" cellpadding=""
               bgcolor="">
            <thead>
            <tr>
                <th class="">Spieler</th>
		...
		?>
        <input type='submit' class="btn btn-block btn-large"
               value='<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCH_SAVE_PRESSEBERICHT'); ?>' onclick=''/>
        ...
        <input type="hidden" name="match_id"
               value="<?php echo Factory::getApplication()->input->getInt('match_id', 0); ?>"/>
