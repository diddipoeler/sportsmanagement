        ...
        <tr>
                                ...
                                <table>
                                    <tr>
                                        <td width="100" align="right"
                                            class="key"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_NR'); ?></td>
                                        <td>
                                            <input type='text' name='tempaddmatchescount' id='tempaddmatchescount'
                                                   value='0' size='3' class='inputbox'/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="100" align="right"
                                            class="key"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_START_HERE'); ?></td>
                                        <td><?php echo $this->lists['addToRound']; ?></td>
                                    </tr>
                                    <tr>
                                        <td width="100" align="right"
                                            class="key"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_AUTO_PUBL'); ?></td>
                                        <td><?php echo $this->lists['autoPublish']; ?></td>
                                    </tr>
                                    <tr>
                                        <td width="100" align="right"
                                            class="key"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_FIRST_MATCHNR'); ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type='text' name='startTime'
                                                   value='<?php echo $this->projectws->start_time; ?>' size='4'
                                    ...
                                    <tr>
                                        <td width="100" colspan='2'>
                                            <input type='submit'
                                                   value='<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_NEW_MATCHES'); ?>'
            ...
            <td valign='top' width='50%'>
                <table class="table">
                    <tr>
                        <td width="100" align="right"
                            class="key"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_COPY2'); ?></td>
                        <td><?php echo $this->lists['project_rounds2']; ?></td>
                    </tr>
                    <tr>
                        <td width="100" align="right"
                            class="key"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_DEFAULT_DATE'); ?></td>
                        <td>
							<?php
							echo HTMLHelper::calendar(
								sportsmanagementHelper::convertDate($this->roundws->round_date_first),
							...
							?>
                            &nbsp;
                            <input type='text' name='time' value='<?php echo $this->projectws->start_time; ?>' size='4'
                                   maxlength='5' class='inputbox'/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="100" align="right"
                            class="key"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_ROUND_TITLE'); ?></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="mirror" class="inputbox">
                                <option value="0"
                                        selected="selected"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_COPY_MATCHES'); ?></option>
                    ...
                    <tr>
                        <td width="100" colspan='2'>
                            <input type='submit'
                                   value='<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_MATCHES_MASSADD_COPY_MATCHES'); ?>'
                                   onclick='copymatches();'/>
                        </td>
                    </tr>
                </table>
