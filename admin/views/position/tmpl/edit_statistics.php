	...
	<table class="admintable">
		<tr>
			...
			<td align='center' style="width:auto;">
				<input  type="button" class="inputbox"
						onclick="$('statschanges_check').value=1;moveOptionUp('position_statistic');jQuery('#position_statistic option').prop('selected', true);"
						value="<?php echo JText::_('COM_SPORTSMANAGEMENT_GLOBAL_UP'); ?>" />
				<br /><br />
				<input type="button" class="inputbox"
					   onclick="$('statschanges_check').value=1;moveOptionDown('position_statistic');jQuery('#position_statistic option').prop('selected', true);"
