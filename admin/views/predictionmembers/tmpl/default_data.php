        ...
        for ( $i = 0, $n = count($this->items); $i < $n; $i++ )
        {
          ...
          <td>
            ...
            <?php echo HTMLHelper::_('jgrid.checkedout', $i, $this->user->get('id'), $row->checked_out_time, 'predictionmembers.', $canCheckin); ?>
               ...
               <td style='text-align: center; '>
                <?php
                if ($row->reminder) {$imgfile='ok.png';$imgtitle=Text::_('Active');
                }else{$imgfile='delete.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_INACTIVE');
                }
                echo HTMLHelper::_(
               ...
               <td style='text-align: center; '>
                <?php
                if ($row->receipt) {$imgfile='ok.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_ACTIVE');
                }else{$imgfile='delete.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_INACTIVE');
                }
                echo HTMLHelper::_(
                    'image', 'administrator/components/com_sportsmanagement/assets/images/' . $imgfile,
               ...
               <td style='text-align: center; '>
                <?php
                if ($row->show_profile) {$imgfile='ok.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_ALLOWED');
                }else{$imgfile='delete.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_NOT_ALLOWED');
                }
               ...
               <td style='text-align: center; '>
                <?php
                if ($row->admintipp) {$imgfile='ok.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_ACTIVE');
                }else{$imgfile='delete.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_INACTIVE');
                }
                echo HTMLHelper::_(
                    'image', 'administrator/components/com_sportsmanagement/assets/images/' . $imgfile,
               ...
               <td style='text-align: center; '>
                <?php
                if ($row->approved) {$imgfile='ok.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_APPROVED');
                }else{$imgfile='delete.png';$imgtitle=Text::_('COM_SPORTSMANAGEMENT_ADMIN_PMEMBERS_NOT_APPROVED');
                }
                echo HTMLHelper::_(
                    'image', 'administrator/components/com_sportsmanagement/assets/images/' . $imgfile,
                    $imgtitle, 'title= "' . $imgtitle . '"'
