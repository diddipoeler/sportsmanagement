        ...
        <table class='admintable'>
            ...
            <tr>
                <td nowrap='nowrap' class="key hasTip"
                    title="<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_TYPE_LABEL') . '::' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_TYPE_TIP'); ?>">
            ...
            <tr>
                <td nowrap='nowrap' class="key hasTip"
                    title="<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_STARTTIME_LABEL') . '::' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_STARTTIME_TIP'); ?>">
            ...
            <tr>
                <td nowrap='nowrap' class="key hasTip"
                    title="<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_ROUNDS_INTERVAL_LABEL') . '::' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_ROUNDS_INTERVAL_TIP'); ?>">
            ...
            <tr>
                <td nowrap='nowrap' class="key hasTip"
                    title="<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_STARTDATE_LABEL') . '::' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_STARTDATE_TIP'); ?>">
            ...
            <tr>
                <td nowrap='nowrap' class="key hasTip"
                    title="<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_NEW_ROUND_NAME_LABEL') . '::' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_NEW_ROUND_NAME_TIP'); ?>">
                ...
                <td><input type="text" name="roundname"
                           value="<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_NEW_ROUND_NAME'); ?>"/>
                </td>
            </tr>

            <tr>
                <td nowrap='nowrap' class="key hasTip"
                    title="<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_TEAMS_ORDER_LABEL') . '::' . Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_TEAMS_ORDER_TIP'); ?>">
                ...
                <td>
                    ...
                    <div id="ordering_buttons">
                        <button type="button"
                                id="buttonup"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_TEAMS_ORDER_UP') ?></button>
                        <button type="button"
                                id="buttondown"><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_POPULATE_TEAMS_ORDER_DOWN') ?></button>
                    </div>
                </td>
            </tr>
