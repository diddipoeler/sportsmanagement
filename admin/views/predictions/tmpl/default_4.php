    ...
    <div class="col-md-8">
        <div id="dashboard-icons" class="dashboard-icons">
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=predictiongames">
                <img src="components/com_sportsmanagement/assets/icons/tippspiel.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_EXT_PREDICTION_GAMES') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=predictiongroups">
                <img src="components/com_sportsmanagement/assets/icons/tippspielgruppen.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_EXT_PREDICTION_GROUPS') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=predictionmembers">
                <img src="components/com_sportsmanagement/assets/icons/tippspielmitglieder.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_EXT_PREDICTION_MEMBERS') ?>"/><br/>
            ...
            <a class="btn btn-jsm-dash" href="index.php?option=com_sportsmanagement&view=predictiontemplates">
                <img src="components/com_sportsmanagement/assets/icons/tippspieltemplates.png"
                     alt="<?php echo Text::_('COM_SPORTSMANAGEMENT_EXT_PREDICTION_TEMPLATES') ?>"/><br/>
