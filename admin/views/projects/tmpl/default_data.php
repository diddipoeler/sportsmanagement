...
$pcture_link = 'index.php?option=com_sportsmanagement&view=imagelist&tmpl=component&asset=com_sportsmanagement&author=&folder=projectimages'.'&pid='.$row->id;
					...
					echo sportsmanagementHelper::getBootstrapModalImage('projectimages' . $row->id, Uri::root() . 'administrator/components/com_sportsmanagement/assets/images/link.png', Text::_('COM_SPORTSMANAGEMENT_ADMIN_PROJECTS_PROJECTSPICTURE'), '20', Uri::base() . $pcture_link, $this->modalwidth, $this->modalheight);
					?>
                </td>
...
echo HTMLHelper::_('image', 'administrator/components/com_sportsmanagement/assets/images/information.png',$imageTitle, $image_attributes);
                ...
                <td class="center">
					...
					{
						?>
                        <input type="text" size="100" class="inputbox" name="user_field<?php echo $row->id; ?>"
                               value="<?php echo $row->user_fieldvalue; ?>"
                               onchange="document.getElementById('cb<?php echo $i; ?>').checked=true"/>
                        <input type="text" size="10" class="inputbox" name="user_field_id<?php echo $row->id; ?>"
                               value="<?php echo $row->user_field_id; ?>">
						<?PHP
					}
					?>
                </td>
