    ...
    <fieldset class='adminform'>
        ...
        <form id='copyform' method='post' style='display:inline' id='copyform'>
            ...
            <table class='admintable'>
                ...
                <tr>
                    <td class='key'
                        nowrap='nowrap'><?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_MASSADD_COUNT'); ?></td>
                    <td><input type='text' name='add_round_count' id='add_round_count' value='0' size='3'
                               class='inputbox'/></td>
                    <td><input type='submit' class='button'
                               value='<?php echo Text::_('COM_SPORTSMANAGEMENT_ADMIN_ROUNDS_MASSADD_SUBMIT_BUTTON'); ?>'
