...
for ($i = 0, $n = count($this->items); $i < $n; $i++) {
    ...
    $assignteams = Route::_('index.php?option=com_sportsmanagement&tmpl=component&view=seasons&layout=assignteams&id=' . $row->id);
    $assignpersons = Route::_('index.php?option=com_sportsmanagement&tmpl=component&view=seasons&layout=assignpersons&id=' . $row->id);
