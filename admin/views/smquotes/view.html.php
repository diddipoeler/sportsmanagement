<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 administrator Smquotes view.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(HtmlView::class)) {
    throw new \RuntimeException('SportsManagement native administrator Smquotes view could not be loaded.', 500);
}
