...
<div id="editcell">
    <table class="<?php echo $this->table_data_class; ?>">
        <thead>
            <tr>
                <th width="1%" class="nowrap text-center d-none d-md-table-cell"><?php echo JText::_('COM_SPORTSMANAGEMENT_GLOBAL_NUM'); ?></th>
            ...
            for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                ...
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td class="has-context">
                        ...
                        <?php if ($canEdit) : ?>
                            <a href="<?php echo JRoute::_('index.php?option=com_sportsmanagement&task=sportstype.edit&id=' . (int) $row->id); ?>">
                                <span class="fa fa-pencil-square mr-2" aria-hidden="true"></span> <?php echo $this->escape($row->name); ?></a>
                        <?php else : ?>
                    ...
                    <td>
                        ...
                        echo JHtml::_('select.genericlist', $this->lists['sportart'], 'sportstype_id' . $row->id, 'class="custom-select form-control" size="1"' . $append, 'value', 'text', $row->sportsart);
                        //echo $row->sportsart; 
                        ?>
                    </td>
                    <td class="text-center">
