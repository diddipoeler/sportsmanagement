                ...
                <td class="center">
                    ...
                    if ($row->season_picture == '') {
                        ...
                        echo JHtml::_('image',
                            ...
                            'title= "' . $imageTitle . '"');
                        ?>
                        <a href="<?php echo JURI::root() . $row->season_picture; ?>" title="<?php echo $imageTitle; ?>"
                           class="modal">
                            <img src="<?php echo JURI::root() . $row->season_picture; ?>"
                        ...
                        ?>
                        <a href="<?php echo JURI::root() . $row->season_picture; ?>" title="<?php echo $playerName; ?>"
                           class="modal">
                            <img src="<?php echo JURI::root() . $row->season_picture; ?>"
