...
if (count($clubs) > 0)
{
	switch ($mode)
	{
                            ...
                            <div class="item <?php echo $active; ?>">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-item">
                                            <div class="photo">
                                                <img src="<?php echo $thispic; ?>" class="img-responsive"
                                                     alt="<?php echo $club->name; ?>" width="60"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
		...
		case 'B2':
			?>
            <div id="myClubBirthday<?php echo $module->id; ?>" class="carousel slide" data-interval="3000"
                 data-ride="carousel">
                <!-- Indicators -->
                <ol class="carousel-indicators">
					...
					for ($a = 0; $a < count($clubs); $a++)
					{
						...
						?>
                        <li data-target="#myClubBirthday<?php echo $module->id; ?>"
                ...
                <div class="carousel-inner" role="listbox">
					...
					foreach ($clubs AS $club)
					{
						...
						?>
                        <div class="item <?php echo $active; ?>">
                            <img src="<?php echo $thispic; ?>" alt="<?php echo $club->name; ?>"
                ...
                <a class="left carousel-control" href="#myClubBirthday<?php echo $module->id; ?>" role="button"
                   data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="right carousel-control" href="#myClubBirthday<?php echo $module->id; ?>" role="button"
                   data-slide="next">
