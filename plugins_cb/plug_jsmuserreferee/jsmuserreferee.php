 ...
 * @subpackage plug_jsmuserreferee
 * @file       jsmuserreferee.php
 ...
 */
class getjsmuserrefereeTab extends cbTabHandler
{
    /**
     * Construnctor
     */
    function getjsmuserrefereeTab()
    {
        $this->cbTabHandler();
    }
    ...
    */
    function getDisplayTab($tab,$user,$ui)
    {
        ...
        $helloworld_tab_message = $params->get('hwTabMessage', "JSM SportsManagement!");
...
} // end of getjsmuserrefereeTab class
?>
