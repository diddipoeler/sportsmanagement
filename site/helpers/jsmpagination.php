...
class sportsmanagementModelJSMPagination extends BaseDatabaseModel
{
 /**
    ...
    public function getPagesCounter()
    {
      ...
      //Factory::getApplication()->enqueueMessage('Your Message', 'type');
    ...
    public function getPagesLinks()
    {
      ...
      //Factory::getApplication()->enqueueMessage('<pre>'.print_r($data,true).'</pre>', 'notice');
    ...
    protected function _buildDataObject()
    {
      ...
      //Factory::getApplication()->enqueueMessage('<pre>'.print_r($this->additionalUrlParams,true).'</pre>', 'notice');
      ...
      //Factory::getApplication()->enqueueMessage('data all <pre>'.print_r($data->all,true).'</pre>', 'notice');
...
//          Factory::getApplication()->enqueueMessage('prefix <pre>'.print_r($this->prefix,true).'</pre>', 'notice');
  ...
  //    Factory::getApplication()->enqueueMessage('data all <pre>'.print_r($data->all,true).'</pre>', 'notice');
     ...
     // Factory::getApplication()->enqueueMessage('prefix <pre>'.print_r($this->prefix,true).'</pre>', 'notice');
       //   Factory::getApplication()->enqueueMessage('page <pre>'.print_r($page,true).'</pre>', 'notice');
          
        }

      
         //Factory::getApplication()->enqueueMessage('data <pre>'.print_r($data,true).'</pre>', 'notice');
