<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 frontend Playground model.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
if (!class_exists(PlaygroundModel::class)) {
    foreach ([
        ...
        JPATH_SITE . '/components/com_sportsmanagement/src/Model/PlaygroundModel.php',
    ] as $nativeFile) {
