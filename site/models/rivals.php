...
if (!class_exists(RivalsModel::class)) {
    foreach ([
        ...
        JPATH_SITE . '/components/com_sportsmanagement/src/Model/RivalsModel.php',
    ] as $nativeFile) {
...
if (!class_exists(RivalsModel::class)) {
    throw new \RuntimeException('SportsManagement native Rivals model could not be loaded.', 500);
}
