<?php
/**
 * Legacy compatibility bridge for the native Joomla 5/6 frontend Scoresheet model.
 *
 * @version    5.6.0
...
if (!class_exists(ScoresheetModel::class)) {
    foreach ([
        ...
        JPATH_SITE . '/components/com_sportsmanagement/src/Model/ScoresheetModel.php',
    ] as $nativeFile) {
...
if (!class_exists(ScoresheetModel::class)) {
    throw new \RuntimeException('SportsManagement native Scoresheet model could not be loaded.', 500);
}
