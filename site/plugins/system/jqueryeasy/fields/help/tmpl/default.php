...
<div class="help">
	...
	<ul>
		<li><img src="../plugins/system/jqueryeasy/images/jquery.png"><a href="<?php echo $jquery_link; ?>" target="_blank">jQuery.com</a></li>
		<li><img src="../plugins/system/jqueryeasy/images/jqueryui.png"><a href="<?php echo $jqueryui_link; ?>" target="_blank">jQueryUI.com</a></li>
