...
if (!class_exists(SportsManagementRouterService::class)
    || !class_exists(SiteRouteSchema::class)
    || !class_exists(SportsManagementSiteApplicationResolver::class)
) {
    $routeSchema = __DIR__ . '/src/Service/SiteRouteSchema.php';
    $nativeRouter = __DIR__ . '/src/Service/Router.php';
    $applicationResolver = __DIR__ . '/src/Service/SportsManagementSiteApplicationResolver.php';
    ...
    if (is_file($applicationResolver)) {
        require_once $applicationResolver;
    }
}
...
if (!class_exists(SportsManagementRouterService::class)
    ...
    throw new \RuntimeException('SportsManagement native site router runtime could not be loaded.', 500);
}
...
class SportsmanagementRouter extends SportsManagementRouterService implements RouterInterface
{
    ...
    public function __construct(?CMSApplicationInterface $app = null, ?AbstractMenu $menu = null)
    {
        ...
        // application/menu pair. The optional factory/database arguments remain
        // null because this router does not use them.
        parent::__construct(
            $app,
            $menu,
            null,
