<?php
/**
 * Joomla 5/6 site list model for clubs.
 *
 * @version    5.6.0
 * @author     diddipoeler
...
{
    protected $_identifier = 'allclubs';
    protected $limitstart = 0;
    protected $limit = 0;
    protected $use_current_season = false;
    protected $sports_type = 0;
    ...
    public function __construct($config = [], ?MVCFactoryInterface $factory = null)
    {
        ...
        $config['filter_fields'] = [
            'v.name', 'v.logo_big', 'v.website', 'v.address', 'v.zipcode',
            'v.location', 'v.country', 'v.unique_id', 'v.phone', 'v.email',
        ];
    ...
    {
        $defaultLimit = (int) $this->siteApplication()->getConfig()->get('list_limit', 20);
