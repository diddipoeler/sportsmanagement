<?php
namespace Diddipoeler\Component\SportsManagement\Site\View\Allleagues;
...
final class HtmlView extends SportsManagementHtmlView
{
    ...
    {
        $config['template_path'] = JPATH_SITE . '/components/com_sportsmanagement/views/allleagues/tmpl';
    ...
    public function display($tpl = null)
    {
        ...
        if (!$model instanceof AllleaguesModel) {
            throw new \RuntimeException('Allleagues view requires AllleaguesModel.', 500);
        }
        ...
        $this->getDocument()->setTitle(Text::_('COM_SPORTSMANAGEMENT_ALLLEAGUES_PAGE_TITLE'));
