...
<fieldset class="adminform">
    <legend><?php echo $escape(Text::_((string) ($this->teams->team1 ?? ''))); ?></legend>
                        ...
                        <tr id="home-staff-stat-row-<?php echo $j; ?>" class="staffstatrow">
                            <td style="text-align:left;">
                                ...
                                <input
                                    ...
                                    id="home-staff-stat-cb-<?php echo $j; ?>"
                                    name="staffcid[]"
                                    value="<?php echo $j; ?>"
                                >
                            </td>
