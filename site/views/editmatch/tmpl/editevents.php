			...
			<table id="table-event" class='adminlist'>
				...
				<tbody>
					...
					<tr id="row-new">
						...
						<td style="" id="cell-player-<?php echo $this->teams->projectteam2_id; ?>"><?php echo $this->lists['homeroster']; ?></td>
						<td style="display:none;" id="cell-player-<?php echo $this->teams->projectteam1_id; ?>"><?php echo $this->lists['awayroster']; ?></td>
