...
<div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo JText::_($row->methode); ?>"><?php echo JText::_($row->methode); ?></a>
                </h4>
            </div>
            <div id="<?php echo JText::_($row->methode); ?>" class="panel-collapse collapse">
