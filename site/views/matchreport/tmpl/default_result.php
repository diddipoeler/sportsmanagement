...
<?PHP
echo sportsmanagementHelperHtml::getBootstrapModalImage('team2mare'.$this->team1->id,
$picture,
$this->team1->name,
...
echo sportsmanagementHelperHtml::getBootstrapModalImage('team2mare'.$this->team2->id,
$picture,
$this->team2->name,
$this->config['team_picture_width'],
'',
