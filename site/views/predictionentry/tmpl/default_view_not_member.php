...
<form name='predictionRegisterForm' id='predictionRegisterForm' method='post'
      action="<?php echo Route::_('index.php?option=com_sportsmanagement&task=predictionentry.register'); ?>">
    <input type='submit' name='register'
           value='<?php echo Text::_('COM_SPORTSMANAGEMENT_PRED_ENTRY_NOT_MEMBER_INFO_07'); ?>' class='button'/>
    ...
    <input type='<?php echo $visible; ?>' name='approved'
           value='<?php echo ($this->predictionGame->auto_approve) ? '1' : '0'; ?>'/>
