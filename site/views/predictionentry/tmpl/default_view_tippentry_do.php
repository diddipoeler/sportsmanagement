...
else
{
	foreach (sportsmanagementModelPrediction::$_predictionProjectS AS $predictionProject)
	{
			...
			// If ( ( ( $this->model->pjID == $predictionProject->project_id ) && ($gotSettings) )  )
		{
			...
			$memberProjectJokersCount = sportsmanagementModelPrediction::getMemberPredictionJokerCount(
                ...
                <div class="table-responsive">
                    <table class="table table-responsive">
                        <tr>
							...
							echo Text::sprintf(
								'COM_SPORTSMANAGEMENT_PRED_ENTRY_SUBTITLE_02',
            ...
            <form name='<?php echo $formName; ?>' id='<?php echo $formName; ?>' method='post'
                ...
                <input type='hidden' name='pjID'
                       value='<?php echo (int) sportsmanagementModelPredictionEntry::$pjID; ?>'/>
                <input type='hidden' name='pids[]' value='<?php echo (int) sportsmanagementModelPrediction::$pjID; ?>'/>
                <input type='hidden' name='ptippmode[<?php echo (int) sportsmanagementModelPrediction::$pjID; ?>]'
                       value='<?php echo $predictionProject->mode; ?>'/>
                ...
                <div class="table-responsive">
                    <table class="<?PHP echo $this->config['table_class']; ?> table-responsive">
                        <tr>
							...
							if ($predictionProject->use_goals)
							{
                                ...
                                <td>
                                    ...
                                    <input type="text"
                                           id="goals_<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>"
                                           name="goals[<?php echo $predictionProject->project_id; ?>][<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>]"
                                           value="<?php echo 0; ?>"/>
                                </td>
								<?php
							}
							...
							if ($predictionProject->use_penalties)
							{
                                ...
                                <td>
                                    ...
                                    <input type="text"
                                           id="penalties_<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>"
                                           name="penalties[<?php echo $predictionProject->project_id; ?>][<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>]"
                                           value="<?php echo 0; ?>"/>
                                </td>
								<?php
							}
							...
							if ($predictionProject->use_cards)
							{
                                ...
                                <td>
                                    ...
                                    <input type="text"
                                           id="yellowcards_<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>"
                                           name="yellowcards[<?php echo $predictionProject->project_id; ?>][<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>]"
                                           value="<?php echo 0; ?>"/>

									<?php echo Text::_('COM_SPORTSMANAGEMENT_E_YELLOW-RED_CARD'); ?>
                                    <input type="text"
                                           id="yellowredcards_<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>"
                                           name="yellowredcards[<?php echo $predictionProject->project_id; ?>][<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>]"
                                           value="<?php echo 0; ?>"/>

									<?php echo Text::_('COM_SPORTSMANAGEMENT_E_RED_CARD'); ?>
                                    <input type="text"
                                           id="redcards_<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>"
                                           name="redcards[<?php echo $predictionProject->project_id; ?>][<?php echo (int) sportsmanagementModelPrediction::$roundID; ?>]"
                                           value="<?php echo 0; ?>"/>
                                </td>
								<?php
							}
                        ...
                        <tr>
                            <th style='color:white ;background-color:teal;'><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_HOME_TEAM'); ?></th>
                            </th>
                            <th style='color:white ;background-color:teal;'><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_AWAY_TEAM'); ?></th>
                            </th>
                            <th style='color:white ;background-color:teal;'><?php echo Text::_('COM_SPORTSMANAGEMENT_PRED_RANK_PREDICTIONS'); ?></th>
                            </th>
							<?php
							...
							foreach ($roundResults AS $result)
							{
                                ...
                                <tr class='<?php echo $class; ?>'>
									...
									if ($pred_matchdatetime != $prev_pred_matchdatetime)
									{
										?>
                                        <td colspan='4'
                                            style="text-align: center;font-weight:bold; "><?php echo $pred_matchdatetime; ?></td><?php
                                ...
                                <td nowrap='nowrap' class="td_c">
										...
										// If ( $this->config['show_logo_small_overview'] == 1 ) //wir nehmen das kleine logo!
									{
										...
										case 'logo_big':
											...
											echo sportsmanagementHelperHtml::getBootstrapModalImage(
												'tippteaminfoaway' . $result->projectteam2_id,
												$logo_away,
												$imgTitle,
												30,
												'',
    ...
    value="' . $result->prid . '" />';
									...
									{
										echo $this->createStandardTippSelect(
											$result->tipp_home,
											$result->tipp_away,
											$result->tipp,
									...
									{
										echo $this->createTotoTippSelect(
											$result->tipp_home,
											$result->tipp_away,
											$result->tipp,
											$predictionProject->project_id,
								...
								if (($predictionProject->joker) && ($predictionProject->mode == 0))
								{
									...
									if (isset($result->joker) && ($result->joker == '1'))
									{
                        ...
                        <tr>
							...
							else
							{
                                ...
                                <td class="td_c">
									...
									?><input type='submit' name='addtipp'
                                             style='color:white; background-color:teal; font-weight:bold;'
                                             value='<?php echo Text::_('JSAVE'); ?>' class='button'/><?php
									}
									else
									{
										?>&nbsp;<?php
