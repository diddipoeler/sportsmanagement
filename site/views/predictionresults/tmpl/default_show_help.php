...
if (!isset($this->config['show_scoring']))
{
	$this->config['show_scoring'] = 1;
}
...
<ul>
    ...
    <li><i><?php
			...
			{
			?></i></li>
    <li><i><?php echo Text::_('COM_SPORTSMANAGEMENT_PRED_RESULTS_NOTICE_INFO_07');
			?>
            <table class='blog' cellpadding='0' cellspacing='0'>
                <tr>
                    <td class='sectiontableheader'
                        style='text-align:center; '><?php echo Text::_('COM_SPORTSMANAGEMENT_PRED_RESULTS_RESULT'); ?></td>
                    <td class='sectiontableheader'
                        style='text-align:center; '><?php echo Text::_('COM_SPORTSMANAGEMENT_PRED_RESULTS_YOUR_PREDICTION'); ?></td>
                    <td class='sectiontableheader'
                        style='text-align:center; '><?php echo Text::_('COM_SPORTSMANAGEMENT_PRED_RESULTS_POINTS'); ?></td>
					<?php
					if (($this->model->predictionProject->joker) && ($this->model->predictionProject->mode == 0))
					{
						?>
                        <td class='sectiontableheader'
                            style='text-align:center; '><?php echo Text::_('COM_SPORTSMANAGEMENT_PRED_RESULTS_JOKER_POINTS'); ?></td><?php
					}
					?>
                </tr>
