    ...
    <table class="table">
		...
		if ($this->config['allow_alias'])
		{
            ...
            <tr>
				...
				?>
                <td colspan='2'>
                    <input class='inputbox' type='text' name='aliasName'
                           size='<?php echo $this->config['input_alias_length']; ?>' maxlength='255'
		...
		if ($this->config['edit_slogan'])
		{
            ...
            <tr>
				...
				?>
                <td colspan='2'>
                    <input class='inputbox' type='text' name='slogan'
                           size='<?php echo $this->config['input_slogan_length']; ?>' maxlength='255'
