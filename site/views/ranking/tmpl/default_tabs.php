...
echo JHtml::_('bootstrap.addTab', 'defaulttabs', 'rankingall', Text::_('ranking'));
...
echo JHtml::_('bootstrap.endTab');
                ...
                if ($this->config['show_projectinfo']) {
                  echo JHtml::_('bootstrap.addTab', 'defaulttabs', 'projectinfo', Text::_('projectinfo'));
                    echo $this->loadTemplate('projectinfo');
                  echo JHtml::_('bootstrap.endTab');
                }
                if ($this->config['show_notes']) {
                  echo JHtml::_('bootstrap.addTab', 'defaulttabs', 'notes', Text::_('notes'));
                    echo $this->loadTemplate('notes');
                  echo JHtml::_('bootstrap.endTab');
                }
                if ($this->config['show_ranking_maps']) {
                  echo JHtml::_('bootstrap.addTab', 'defaulttabs', 'googlemap', Text::_('googlemap'));
                ...
                if ($this->overallconfig['show_project_rss_feed']) {
                    if ($this->rssfeeditems) {
                      echo JHtml::_('bootstrap.addTab', 'defaulttabs', 'ranking', Text::_('COM_EXAMPLE_NAME'));
