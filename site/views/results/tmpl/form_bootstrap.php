        ...
        <form name="adminForm" id="adminForm" method="post" action="<?php echo $uri->toString(); ?>">
            <div class="row-fluid" style="">
                ...
                <div class="<?php echo $this->divclass; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_ROUND'); ?></div>
                <div class="<?php echo $this->divclass; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_MATCHNR'); ?></div>
                <div class="<?php echo $this->divclass; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_DATE'); ?></div>
                <div class="<?php echo $this->divclass; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_TIME'); ?></div>
                <div class="<?php echo $this->divclass; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_HOME_TEAM'); ?></div>
                <div class="<?php echo $this->divclass; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_AWAY_TEAM'); ?></div>
                <div class="<?php echo $this->divclass; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_RESULT'); ?></div>
                <div class="<?php echo $this->divclass; ?>" style="">
                ...
                <div class="<?php echo $this->divclassrest; ?>"
                     style=""><?php echo Text::_('COM_SPORTSMANAGEMENT_EDIT_RESULTS_PUBLISHED'); ?></div>
            </div>
