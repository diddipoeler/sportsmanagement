...
<div class="mini-player_links">
			<table class="table">
			    ...
			    <td style="width:2%;padding: 0px;">
					...
					{
echo HTMLHelper::image(JURI::root().'images/com_sportsmanagement/database/teamplayers/shirt.php?text='.$row->position_number,$row->position_number,array('title'=> $row->position_number));					
