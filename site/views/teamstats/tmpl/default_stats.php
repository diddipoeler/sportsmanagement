...
<div class="<?php echo $this->divclassrow; ?> table-responsive" id="stats">
    ...
    <table class="table">
		...
		if ($this->config['show_general_stats'])
		{
            ...
            <tr class="sectiontableentry2">
                <td class="statlabel"><?php echo Text::_('COM_SPORTSMANAGEMENT_TEAMSTATS_MATCHES_HIGHEST_LOSS'); ?>:
                </td>
                <td class="statvalue">
            ...
            <tr class="sectiontableentry2">
                <td class="statlabel"><?php echo Text::_('COM_SPORTSMANAGEMENT_TEAMSTATS_MATCHES_HIGHEST_DRAW'); ?>:
                </td>
                <td class="statvalue">
		...
		if ($this->config['show_goals_stats'])
		{
            ...
            <tr class="sectiontableentry2">
                <td class="statlabel"><?php echo Text::_('COM_SPORTSMANAGEMENT_TEAMSTATS_GOALS_TOTAL_PER_MATCH'); ?>:
                </td>
            ...
            <tr class="sectiontableentry2">
                <td class="statlabel"><?php echo Text::_('COM_SPORTSMANAGEMENT_TEAMSTATS_GOALS_AGAINST_PER_MATCH'); ?>
                    :
                </td>
